(function($) {
	$.fn.apDrillDownMenu = function(options) {
	    ...
	    return this.each(function() {
	    	if (this.tagName.toLowerCase() == 'ul') {
				var menu = $(this).addClass(css.menuTop).addClass(css.current);
				...
				menu.find('a').each(function() {
					...
					if (link.next().is('ul')) {
						if (opts.prependCurrentOnChild) {
							...
							if (typeof opts.prepentCurrentOnChildCallback == 'function') {
								opts.prepentCurrentOnChildCallback.apply(clone);
							}
	...
	$.fn.apDrillDownMenu.defaults = {
		...
		prepentCurrentOnChildCallback: function() {}
	};
})(jQuery);